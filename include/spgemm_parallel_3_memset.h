...
#ifndef PARALLELSPGEMM_SPGEMM_PARALLEL_3_MEMSET_H
#define PARALLELSPGEMM_SPGEMM_PARALLEL_3_MEMSET_H

#include <pybind11/pybind11.h>
#include <pybind11/numpy.h>
namespace py = pybind11;

void spgemm_parallel_3_memset(
    int64_t NI,
    int64_t NJ,
    int64_t NK,
...
#endif //PARALLELSPGEMM_SPGEMM_PARALLEL_3_MEMSET_H
