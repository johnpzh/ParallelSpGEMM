...
#ifndef PARALLELSPGEMM_SPGEMM_PARALLEL_5_MATRIX_H
#define PARALLELSPGEMM_SPGEMM_PARALLEL_5_MATRIX_H

#include <pybind11/pybind11.h>
#include <pybind11/numpy.h>
namespace py = pybind11;

void spgemm_parallel_5_matrix(
    int64_t NI,
    int64_t NJ,
    int64_t NK,
...
#endif //PARALLELSPGEMM_SPGEMM_PARALLEL_5_MATRIX_H
