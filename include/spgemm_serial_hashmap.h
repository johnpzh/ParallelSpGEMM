...
#ifndef PARALLELSPGEMM_SPGEMM_SERIAL_HASHMAP_H
#define PARALLELSPGEMM_SPGEMM_SERIAL_HASHMAP_H

#include <pybind11/pybind11.h>
#include <pybind11/numpy.h>
namespace py = pybind11;

void spgemm_serial_hashmap(
    int64_t NI,
    int64_t NJ,
    int64_t NK,
...
#endif //PARALLELSPGEMM_SPGEMM_SERIAL_HASHMAP_H
